                ...
                if (data) {
                    ...
                    if (data.image_path) {
                        ...
                        if (signedData?.signedUrl) {
                            ...
                            // Silently fallback to public url if signing fails
            ...
            >
                ...
                <View style={styles.detailsContainer}>
                    ...
                    <View style={styles.metaGrid}>
                        ...
                        <View style={styles.metaItem}>
                            <Ionicons name="diamond-outline" size={18} color={colors.primaryLight} style={styles.metaIcon} />
                            <Text style={styles.metaLabel}>Cost</Text>
                            <Text style={styles.metaValue}>{imageRecord.cost} Credits</Text>
                        </View>
                        
                        <View style={styles.metaItem}>
                            <Ionicons name={imageRecord.publicstate ? "globe-outline" : "lock-closed-outline"} size={18} color={colors.primaryLight} style={styles.metaIcon} />
                            <Text style={styles.metaLabel}>Visibility</Text>
                            <Text style={styles.metaValue}>{imageRecord.publicstate ? "Public" : "Private"}</Text>
                        </View>
